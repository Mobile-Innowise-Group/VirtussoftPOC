...
class LightColors implements AppColors {
  ...
  @override
  Color get primary => const Color(0xFF458892);

  @override
  Color get error => const Color.fromRGBO(220, 47, 2, 1);

  @override
  Color get secondary => const Color(0xFFDDEEEF);
  ...
  @override
  Color get textSecondary => const Color(0xFF1C2B30);

  @override
  Color get onSurface => const Color(0xFF1C2B30);

  @override
  Color get divider => const Color.fromRGBO(197, 198, 204, 1);

  @override
  Color get unSelectedIcon => const Color(0xFF1C2B30);
}
